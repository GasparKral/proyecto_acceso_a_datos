...
public class ControladorEmpleados extends HashSet<Empleado> {
    ...
    public void modificarEmpleado(int idOriginal,int id, String apellido, int director, double salario, String oficio, Date fecha_alta, Double comision, Integer departamento) {
        Empleado empleadoOriginal = null; // Creamos una objeto empleado para buscar en la coleccion
        Empleado empleadoReemplazo = new Empleado(id,apellido,director,salario,oficio,fecha_alta,comision,departamento); // Creamos al empleado que reemplazará al empleado original
    ...
    public void crearEmpleado(int id, String apellido, int director, double salario, String oficio, Date fecha_alta, Double comision, Integer departamento) {
